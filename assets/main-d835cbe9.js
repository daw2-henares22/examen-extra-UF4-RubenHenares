...
const series = [
  {
    ...
    imagen_url: "https://upload.wikimedia.org/wikipedia/commons/3/38/Stranger_Things_logo.png"
  },
  {
...
const home = {
  template: `
    <div class="container pt-5">
          ...
          <div class="row">
            <!-- card -->
            <div id="cuerpoFotos"></div>
            <div id="fichaFotos"></div>
            `,
  script: () => {
    let html = ``;
    series.forEach((serie) => {
      html += `
            ...
            `;
      document.querySelector("#cuerpoFotos").innerHTML = html;
      html += `
				<!-- ficha ampliada -->
				<div class="col-6">
					<div class="card shadow mt-2">
        ...
        `;
      document.querySelector("#fichaFotos").innerHTML = html;
    });
  }
};
const login = {
